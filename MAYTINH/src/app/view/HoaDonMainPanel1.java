...
public class HoaDonMainPanel1 extends javax.swing.JPanel {
    ...
    private static void writeExcel(List<HoaDonDTO> listHoaDon) {
        ...
        String fileName = "src/FileExcel/data_" + formattedDateTime + ".xlsx";
    ...
    private void initComponents() {
        ...
        btnXuatDanhSach.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnReload, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 34, Short.MAX_VALUE)
    ...
    private void btnLocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLocActionPerformed
        ...
        if (trangThai.equalsIgnoreCase("Đã Thanh Toán")) {
            ...
            trangThai = "0";
        } else if (trangThai.equalsIgnoreCase("Chọn")) {
            trangThai = null;
        } else {
            trangThai = "2";
        }
