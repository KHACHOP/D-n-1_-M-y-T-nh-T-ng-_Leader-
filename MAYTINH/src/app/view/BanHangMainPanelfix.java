...
//        cbo_size.addItem("12 inch");
//        cbo_size.addItem("14 inch");
//        cbo_size.addItem("15 inch");
//        cbo_size.addItem("16 inch");
//        cbo_size.addItem("17 inch");
////        Cbo 
//        cbo_mausac.removeAllItems();
//        cbo_mausac.addItem("Chọn");
//        cbo_mausac.addItem("Đen");
//        cbo_mausac.addItem("Bạc");
//        cbo_mausac.addItem("Đỏ");
//        cbo_mausac.addItem("Trắng");

        cbo_hang.removeAllItems();
        cbo_hang.addItem("Chọn");
        cbo_hang.addItem("dell");
        cbo_hang.addItem("HP");
        cbo_hang.addItem("LENOVO");
        cbo_hang.addItem("SAMSUNG");
        cbo_hang.addItem("SONY");
        cbo_hang.addItem("LOẠI KHÁC");
    ...
    private void initComponents() {
        ...
        btn_search.setBackground(new java.awt.Color(0, 204, 102));
        ...
        btnLoc.setBackground(new java.awt.Color(0, 204, 102));
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cbo_hang, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        btnTimKiemKhachHang.setBackground(new java.awt.Color(0, 204, 102));
        ...
        btnTinhTienThua.setBackground(new java.awt.Color(204, 204, 204));
        ...
        btnThemVoucher.setBackground(new java.awt.Color(204, 204, 204));
        ...
        btnChoThanhToan.setBackground(new java.awt.Color(204, 204, 204));
        ...
        btnNewHoaDon.setBackground(new java.awt.Color(204, 204, 204));
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                                .addComponent(btnChoThanhToan, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(btnNewHoaDon, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE))
                            ...
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addComponent(btnTinhTienThua, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGap(18, 18, 18)
                                .addComponent(btn_thanhtoan, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap())
        );
        ...
        btn_xoagh.setBackground(new java.awt.Color(204, 204, 204));
        btn_xoagh.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btn_xoagh.setText("Delete/Xóa");
...
//        Lấy mã chi tiết sản phẩm. 
        ...
        if (txt_maKH.getText() == null || txt_tenKH.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Vui lòng nhập thông tin khách hàng để bảo hành");
            return;
            // valaidate  răng buộc có thông tin khách hàng mới  thanh toán được 
        }
...
//          hoaDonService.inHoaDonRaPDF(maHoaDon);
    ...
    private void btnLocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLocActionPerformed
        ...
        List<ChiTietSanPham> chiTietSanPhams = spcts.locSanPham(hang);
        if (chiTietSanPhams.size() > 0) {
            loadToTableSPCT(chiTietSanPhams);
        } else {
            JOptionPane.showMessageDialog(this, "Không tìm thấy sản phẩm phù hợp\n" + "");
